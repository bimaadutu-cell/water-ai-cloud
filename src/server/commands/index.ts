...
const H: Record<string, Handler> = {
  ...
  emojisl: ext.emojisl,
  autoai: ext.autoai,
  autoaioff: ext.autoaioff,
  termux: ext.termux,
  webtoapp: ext.webtoapp,
  batalwebtoapp: ext.batalwebtoapp,
  blockblast: ext.blockblast,
  blockblas: ext.blockblast,
  block: ext.blockblast,
  ...
  allgame: info.allgame,
  games: info.games,
  pokigames: info.pokigames,
  quiz: info.quiz,
  trivia: info.trivia,
