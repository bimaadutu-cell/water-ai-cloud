...
export const REGISTRY: RegistryCommand[] = [
  ...
  c("stickersearch", "sticker", "Cari sticker (butuh sumber yang mengizinkan)"),
  c("stickerpack-search", "sticker", "Cari sticker pack dari provider yang dikonfigurasi"),
  c("sps", "sticker", "Alias .stickerpack-search"),
  c("fakech", "image", "Generator template image quote; hasil diberi label template"),
  c("windowspink", "image", "Generator template Windows retro/pink"),
  c("fakeswwa", "image", "Mockup desain WhatsApp dengan label DEMO/MOCKUP/SIMULATION"),
  c("img2img", "image", "Edit gambar melalui provider image-edit yang dikonfigurasi"),
  ...
  c("toquickvideo", "media", "Optimasi video menjadi MP4 kompatibel WhatsApp"),
  ...
  c("play2", "downloader", "Spotify search HTML + player: .play2 <judul>"),
  c("play3", "downloader", "SoundCloud search HTML: .play3 <judul>"),
  ...
  c("emojisl", "fun", "Reaction emoji random ke saluran: .emojisl lalu kirim URL channel"),
  c("autoai", "ai", "Mode AI tanpa prefix di chat ini"),
  c("autoaioff", "ai", "Matikan mode AUTO AI"),
  c("webtoapp", "tools", "Website → APK guide/build pack: .webtoapp"),
  c("batalwebtoapp", "tools", "Batalkan sesi WebToApp"),
  ...
  c("chess4", "fun", "CHESS CAP 4 HTML interaktif: .chess4 / VS Computer / Two Player"),
  ...
  c("allgame", "fun", "Alias .allgames"),
  c("games", "fun", "Alias .allgames"),
  c("pokigames", "fun", "Alias .allgames — katalog Poki"),
  c("tictac", "fun", "Alias .tictactoe"),
