    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 pb-16 pt-28 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:pt-36">
        <div>
          ...
          <p className="anim-fade-up mt-3 text-sm font-medium text-cyan-300/90 sm:text-base">
            <TypeWriter
              phrases={[
                "Bot WhatsApp cloud 24/7 · tanpa VPS",
                "AI · Downloader · Games · Interactive",
                "QR / Pairing · Multi-bot · Realtime SSE",
                "Premium automation, siap production",
              ]}
            />
          </p>
